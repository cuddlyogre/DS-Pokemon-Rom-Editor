...
namespace DSPRE.ROMFiles {
    ...
    public class TextArchive : RomFile {
        ...
        void LoadFile(Stream data, List<string> msg, bool discardLines) {
                                    ...
                                    if (specialCharON) {
                                        ...
                                        while (true) {
                                            ...
                                            if (shift >= 0xF) {
                                                ...
                                                key1 += 0x493D;
                                                key1 &= 0xFFFF;
                                                car = Convert.ToUInt16(reader.ReadUInt16() ^ key1);
                                                j++;
                                            }
                                        }
