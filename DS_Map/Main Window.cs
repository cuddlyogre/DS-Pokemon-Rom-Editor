        ...
        */
        ...
        private void addNSBTXButton_Click(object sender, EventArgs e) {
            ...
            if (mapTilesetRadioButton.Checked) {
                ...
                if (mapEditor.mapEditorIsReady) {
                    mapEditor.mapTextureComboBox.Items.Add("Map Texture Pack [" + mapEditor.mapTextureComboBox.Items.Count.ToString("D2") + "]");
                }
            } else {
                ...
                if (mapEditor.mapEditorIsReady) {
                    mapEditor.buildTextureComboBox.Items.Add("Building Texture Pack [" + mapEditor.buildTextureComboBox.Items.Count.ToString("D2") + "]");
                }
            }
            ...
            if (texturePacksListBox.Items.Count > 1) {
                ...
                if (d.Equals(DialogResult.Yes)) {
                    if (mapTilesetRadioButton.Checked) {
                        ...
                        if (mapEditor.mapEditorIsReady) {
                            mapEditor.mapTextureComboBox.Items.RemoveAt(mapEditor.mapTextureComboBox.Items.Count - 1);
                        }
                    } else {
                        ...
                        if (mapEditor.mapEditorIsReady) {
                            mapEditor.buildTextureComboBox.Items.RemoveAt(mapEditor.buildTextureComboBox.Items.Count - 1);
                        }
                    }
        ...
        private void TBLEditortrainerClassPreviewPic_ValueChanged(object sender, EventArgs e) {
            trainerEditor.UpdateTrainerClassPic(tbEditorTrClassPictureBox, (int)((NumericUpDown)sender).Value);
        }
        ...
        private void pbEffectsTrainerCombobox_SelectedIndexChanged(object sender, EventArgs e) {
            int maxFrames = trainerEditor.LoadTrainerClassPic((sender as ComboBox).SelectedIndex);
            trainerEditor.UpdateTrainerClassPic(tbEditorTrClassPictureBox);
